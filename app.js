...
function getMonthStr(monthStr) {
    // Takes a string representing a numeric month (e.g., "01", "02") and returns the corresponding month name as a string (e.g., "January", "February").
}
...
function getDayStr(dayStr) {
    // Converts a numerical string representing a day (e.g., "1", "2", "21") into a string with the appropriate ordinal suffix ("st", "nd", "rd", "th").
}
...
function getDowStr(dowInt) {
    // Converts an integer representing the day of the week into the corresponding day name as a string ("Monday", "Tuesday")
}
...
function getCost() {
    // Creates a string that represents the cost of the newspaper based on the state of humanity input
    // Uses random generator to select between a list of options
}
...
function generateWeather() {
    // Generates the weather content for the front page
}
...
function generateStocks() {
    // Generates the stocks content for the front page
}
...
function generateSports() {
    // Generates the sports content for the front page
}
...
function generatePolitics() {
    // Generates the politics content for the front page
}
...
function generateMainHeadline() {
    // Generates the main headline for the front page
    // Used to generate the main story as well
}
...
function generateMainStory() {
    // Generates the main story content for the front page
}
...
function generateOtherNews() {
    // Generates the other news content for the front page
}
